...
class SucursalsControllerTest < ActionController::TestCase
  ...
  test "should create sucursal" do
    assert_difference('Sucursal.count') do
      post :create, sucursal: { direccion: @sucursal.direccion, nombre: @sucursal.nombre, organizacion_id: @sucursal.organizacion_id }
    end
  ...
  test "should update sucursal" do
    patch :update, id: @sucursal, sucursal: { direccion: @sucursal.direccion, nombre: @sucursal.nombre, organizacion_id: @sucursal.organizacion_id }
    assert_redirected_to sucursal_path(assigns(:sucursal))
  end
